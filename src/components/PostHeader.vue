<template>
  <header>
    <div v-if="post.cover" class="post-cover overflow-hidden relative max-h-cover">
      <div
        class="max-w-xl md:max-w-3xl xl:max-w-4xl text-center px-6 absolute z-10 mx-auto bottom-0 inset-x-0 pb-16"
      >
        <div class="m-auto">
