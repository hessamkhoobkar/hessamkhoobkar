<template>
	<div id="website_header" class="header">
        <div id="site_logo" class="logo">
            <p class="h3">hessam khoobkar</p>
        </div>

        <nav id="main_navigation">
            <g-link class="navItem text_small" to="/" exact>Index</g-link>
            <g-link class="navItem text_small" to="/Work/">Work</g-link>
            <g-link class="navItem text_small" to="/Builds/">Builds</g-link>
            <g-link class="navItem text_small" to="/Blog-Posts/">Blog</g-link>
            <g-link class="navItem text_small" to="/About-Me/">about me</g-link>
        </nav>
        
        <div id="header_socialLinks" class="socialLinks">
            <a id="behance" class="socialLink" href="https://www.behance.net/hessamkhoobkar" target="_blank">
            ...
            <a id="linkedin" class="socialLink" href="https://www.linkedin.com/in/hessam-khoobkar" target="_blank">
            ...
            <a id="instagram" class="socialLink" href="https://www.instagram.com/hessam_khoobkar/" target="_blank">
            ...
            <a id="dribbble" class="socialLink" href="https://dribbble.com/hessam_khoobkar" target="_blank">
            ...
            <a id="emailLink" @click="mailto" @mouseleave="cleanMailToast" class="socialLink" tooltip="Click to copy email address" href="#">
